...
class Question(models.Model):
    ...
    rightAnswer = models.CharField(max_length = 128)
    wrongAnswer1 = models.CharField(max_length = 128)
    wrongAnswer2 = models.CharField(max_length = 128)
    wrongAnswer3 = models.CharField(max_length = 128)
