...
def populate():
    desktop.models.Lab.objects.get_or_create(name="PCR",
                                             number=1,
    ...
    desktop.models.Lab.objects.get_or_create(name="Ligation and transformation",
                                             number=2,
    ...
    desktop.models.Lab.objects.get_or_create(name="Blue/White Screening",
                                             number=3,
    ...
    desktop.models.Lab.objects.get_or_create(name="Plasmid Miniprep",
                                             number=4,
    ...
    desktop.models.Lab.objects.get_or_create(name="DNA sequencing",
                                             number=5,
    ...
    desktop.models.Lab.objects.get_or_create(name="Real-time quantitative PCR",
                                             number=6,
